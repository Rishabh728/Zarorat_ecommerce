  ...
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20 ">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center bg-red-600 py-2 text-white rounded-tl-2xl rounded-tr-2xl  ">About Zarort</h1>
        ...
        <div className="text-center mt-10">
         ...
         <Link to={'/products'}><button className="bg-red-600 text-white px-6 py-2 cursor-pointer hover:bg-red-700 transition duration-300">
            Start Shopping
          </button></Link> 
        </div>
      </div>
